    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center border-b">
        <Link className="flex items-center justify-center" href="#">
          <span className="font-bold text-lg">Stablecoin Manager</span>
        </Link>
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                  Create Your Own Stablecoins
                </h1>
                <p className="max-w-[600px] text-neutral-500 md:text-xl dark:text-neutral-400">
                  Launch and manage stablecoins backed by yield-bearing tokens. Simple, secure, and decentralized.
                </p>
              </div>
        ...
        <section id="features" className="w-full py-12 md:py-24 bg-neutral-50 dark:bg-neutral-900/50">
          <div className="container px-4 md:px-6">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-400">
                    Launch your own stablecoins backed by yield-bearing tokens with just a few clicks.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-400">
                    Mint new stablecoins or redeem them for the underlying tokens anytime.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-400">
                    Monitor your stablecoin portfolio and track total supply in real-time.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-neutral-500 dark:text-neutral-400">
          © 2024 Stablecoin Manager. All rights reserved.
        </p>
