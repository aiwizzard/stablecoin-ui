 ...
 * IMPORTANT: This function must only be called from a Server Action or Route Handler.
 */
export const setAuthCookie = (cookie: Cookie) => {
  // @ts-expect-error - Next.js types are not properly reflecting the cookies() API
